...
- For viewer work, preserve the local account-free workflow, persisted UI preferences in `localStorage`, FastChess live mirror compatibility, and the no-fallback-move engine boundary.
