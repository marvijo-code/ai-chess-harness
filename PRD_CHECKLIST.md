...
- [ ] Make Previous Matches rows clickable so archived games load in the board viewer with matching bot logs.
- [ ] Keep Bot Thinking steady during non-live replay/archived viewing until the user changes move, match, or filter.
...
- [ ] Update durable memory, commit, and push.
